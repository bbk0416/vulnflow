...
Core 72.0.77 is the current defect-patch release on the 72.0.72 feature-frozen line. The project is **not abandoned**: development has moved from feature-building to free-product validation and, later, evidence-driven commercialization.
