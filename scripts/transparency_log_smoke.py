...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="vulnflow_v51_transparency_") as temp_name:
        ...
        checks.extend([
            {"name": "schema_40", "passed": CURRENT_SCHEMA_VERSION == 40 and validate_database_file(db)["schema_version"] == 40},
            {"name": "app_72_0_4", "passed": CURRENT_APP_VERSION == "72.0.13"},
    ...
    payload = {
        "title": "VulnFlow 72.0.13 append-only transparency log verification",
