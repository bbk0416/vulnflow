...
TEST_GROUPS = [['tests/test_production_validation_v81.py',
 ...
 ['tests/test_recovery_v9.py',
  ...
  'tests/test_scanner_asset_reconciliation_v80.py',
  'tests/test_scanner_inventory_reconciliation_v81.py',
  'tests/test_documentation_consistency_v82.py',
...
def main() -> int:
    ...
    expected_counts = (78, 76, 168, 80, 117, 67, 120)
