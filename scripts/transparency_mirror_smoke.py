...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="vulnflow-v53-mirror-") as temp_name:
        ...
        checks.extend([
            {"name": "schema_40", "passed": validate_database_file(db)["schema_version"] == CURRENT_SCHEMA_VERSION == 40},
    ...
    payload = {
        "title": "VulnFlow 72.0.11 transparency mirror gossip verification",
