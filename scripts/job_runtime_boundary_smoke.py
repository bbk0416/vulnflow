...
def main_smoke() -> int:
    ...
    checks = {
        "version_72_0_6": main.CURRENT_APP_VERSION == "72.0.12",
        ...
        "architecture_pass": architecture["status"] == "PASS" and architecture["route_count"] == 241,
    }
    payload = {
        "title": "VulnFlow 72.0.12 background job runtime boundary verification",
