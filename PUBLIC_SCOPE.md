...
- 핵심 운영 문서
- 대표 화면과 아키텍처 이미지
- 핵심 업무 흐름을 검증하는 717개 수집형 핵심 회귀시험과 Chromium 브라우저 E2E 3개
...
공개본은 72.0.92 애플리케이션 소스를 유지하지만, 저장소 가독성과 용량을 위해 공급망·릴리스 검증 산출물을 제외했습니다. 전체 제출 기준본은 별도 보관하며 공개 저장소와 섞지 않습니다.
